...
<body>
	<table border=0 cellspacing=0 cellpadding=0 width=100% height=100%>
		<tr>
			<td align=center>
				<div id=Logout>
					<div id=AwokeMsg><img id=LogoutImg src="${pageContext.request.contextPath}/style/blue/images/logout/logout.gif" border=0 /><font size="5" color="blue">您已退出PHR云管理系统</font></div>
					<div id=LogoutOperate>
						<img src="${pageContext.request.contextPath}/style/blue/images/logout/logout2.gif" border=0 /> 
						
						<%-- 这个超链接不适用<s:a>标签！！ --%>
						<a href="${pageContext.request.contextPath}/jsps/login.jsp">重新进入系统</a>
